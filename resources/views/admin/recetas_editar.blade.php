    ...
    <div class="row"> 
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-heading"><h2>{{ $mensaje }} {{ $receta->nombre }}</h2></div>
                	<div class="panel-body">
						<form class="form-inline" action="/recetas/{{ $receta->id }}" method="POST">
						...
						{{ csrf_field() }} {{ method_field('PUT') }}
							...
							<div id="txtboxToFilter" class="input_fields_wrap">
								...
								@php
									...
									foreach($decode as $values){
										...
										foreach($values as $value){
											...
											echo "<div>
											<br>
											<label for='id-" . $value['id'] . "'>" .$value['nombre']. ":</label>
											<br>
											Calorias: " . $value['calorias'] . " Proteinas: " . $value['proteinas'] . " Grasas: " . $value['grasas'] . " Carbohidratos: " . $value['carbohidratos'] . "
											<br>
											<input id='id-" . $value['id'] . "' type='text' name='" . $value['id'] ."' value='" . $value['cantidad'] ."'><a href='#' class='remove_field'>Remover</a></div>";
										}
									}
								@endphp
